...
user_name = 'user'
load_skeleton_path = 'C:/Users/randulf/Desktop/data/nturgb+d_skeletons/'
save_npy_path = 'C:/Users/randulf/Desktop/data/transferred/'
missing_file_path = 'C:/Users/randulf/Desktop/data/data preprocessing/NTU_RGBD120_samples_with_missing_skeletons.txt'
...
if __name__ == '__main__':
    ...
    datalist = os.listdir(load_skeleton_path)
    ...
    for ind, each in enumerate(datalist):
        ...
        try:
            ...
            if each[:20] in missing_files:
                print('file missing')
                continue 
            loadname = load_skeleton_path+each
            print(each)
