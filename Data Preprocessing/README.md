This file is used as instructor assisting you cleaning the data that you need. Part of the data preprocessing code comes from [here](https://github.com/shahroudy/NTURGB-D).
